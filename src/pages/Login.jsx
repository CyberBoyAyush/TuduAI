      ...
      >
        {success ? (
          ...
          >
            ...
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">Login Successful</h2>
          ...
          <>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">Sign in to manage your tasks</p>
            </div>
